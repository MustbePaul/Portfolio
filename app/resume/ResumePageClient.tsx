      ...
      <div className="mx-auto max-w-4xl px-6 py-12 sm:px-8 sm:py-16">
        ...
        <header className="border-b border-ink-800 pb-8 mb-8">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6 text-sm font-mono text-paper-500 mb-6">
            ...
            <a
              href="tel:+265997765664"
              className="hover:text-signal-blue transition-colors"
            >
              +265 997 765 664
            </a>
            <a
              href="mailto:phiri6paul@gmail.com"
              className="hover:text-signal-blue transition-colors"
            >
              phiri6paul@gmail.com
            </a>
            <a
              href="https://paul-phiri-portfolio.vercel.app"
              className="hover:text-signal-blue transition-colors"
            >
              paul-phiri-portfolio.vercel.app
            </a>
            <a
              href="https://github.com/MustbePaul"
              className="hover:text-signal-blue transition-colors"
            >
              github.com/MustbePaul
            </a>
            <a
              href="https://www.linkedin.com/in/paul-napoleon-phiri"
              className="hover:text-signal-blue transition-colors"
            >
        ...
        <section className="border-b border-ink-800 py-8 grid grid-cols-[auto_1fr] gap-8">
          <div className="font-mono text-xs text-paper-500 uppercase tracking-wider pt-1">
            01
          </div>
          <div>
            ...
            <p className="text-base leading-relaxed text-paper-300">
              Business Information Technology graduate building{" "}
              <span className="font-semibold text-paper-100">
                dependable web and mobile systems
              </span>{" "}
              for banks, NGOs and growing businesses — booking platforms,
              content systems and payment integrations. Comfortable owning a
              feature from database schema to mobile interface, and used to
              shipping under real hosting, connectivity and payment-provider
              constraints.
            </p>
          </div>
        </section>
          ...
          <div>
            ...
            <div className="mb-8">
              <div className="flex flex-wrap items-baseline justify-between gap-4 mb-2">
                ...
                <span className="font-mono text-xs text-paper-500 whitespace-nowrap">
                  Feb 2026 — Sep 2026
                </span>
              </div>
              ...
              <ul className="space-y-2">
                <li className="text-sm text-paper-300 pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1 before:h-1 before:bg-paper-500">
                  Shipped features across three in-house products —{" "}
                  <span className="font-semibold text-paper-100">
                    ZikoSpace
                  </span>
                  ,{" "}
                  ...
                  and the Terex website — in Laravel, PHP, JavaScript, React,
                  Angular and Flutter.
                </li>
                <li className="text-sm text-paper-300 pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1 before:h-1 before:bg-paper-500">
                  Integrated{" "}
                  ...
                  (PayChangu and OneKhusa) into TaxiHire, re-architecting the
                  payment flow mid-build after hosting constraints ruled out the
                  original approach.
                </li>
                <li className="text-sm text-paper-300 pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1 before:h-1 before:bg-paper-500">
                  Delivered role-specific booking, payment and content workflows
                  for passengers, drivers and administrators across web and
                  mobile clients.
                </li>
                <li className="text-sm text-paper-300 pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1 before:h-1 before:bg-paper-500">
                  Rebuilt authentication, routing and theme persistence for
                  ZikoSpace, then delivered its accommodation booking flow end
                  to end.
                </li>
                <li className="text-sm text-paper-300 pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1 before:h-1 before:bg-paper-500">
                  Implemented the Terex website redesign — refreshed hero,
                  partner and initiative content with scroll interactions;
                  currently under review ahead of production.
                </li>
              </ul>
            </div>
            ...
            <div>
              <div className="flex flex-wrap items-baseline justify-between gap-4 mb-2">
                <h3 className="text-lg font-semibold text-paper-100">
                  Operations &amp; Financial Records Assistant
                </h3>
                <span className="font-mono text-xs text-paper-500 whitespace-nowrap">
                  Ongoing
                </span>
              ...
              <ul className="space-y-2">
                <li className="text-sm text-paper-300 pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1 before:h-1 before:bg-paper-500">
                  Manage rental fee collection and maintain accurate financial
                  records.
                </li>
                <li className="text-sm text-paper-300 pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1 before:h-1 before:bg-paper-500">
                  Track income, expenditure and payment documentation for
          ...
          <div>
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-paper-300 mb-4 max-w-prose">
                Mental-wellness app pairing a Flutter client with a versioned
                Laravel API: guided audio and video sessions with saved playback
                progress, mood check-ins feeding mood-informed recommendations,
                therapist discovery and availability, appointment booking,
                bookmarks and support requests.
              </p>
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tech}
                    className="text-xs font-mono text-paper-500 bg-ink-900 border border-ink-700 rounded px-2 py-1"
                  >
                    {tech}
                  </span>
                ))}
            ...
            <div>
              ...
              <p className="text-sm text-paper-300 mb-4 max-w-prose">
                Public storytelling platform backed by a protected CMS managing
                articles, events, vacancies, bookings, newsletters and public
                submissions.
              </p>
              <div className="flex flex-wrap gap-2">
                {[
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-paper-300">
                Malawi University of Science and Technology · Graduated 6 August
                2026
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-paper-300">Kamuzu Academy</p>
            </div>
          </div>
        </section>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-[150px_1fr] gap-6">
                ...
                <div className="text-sm text-paper-300">
                  Laravel · PHP · Node.js · REST APIs · PayChangu · OneKhusa
                </div>
              </div>
              <div className="grid grid-cols-[150px_1fr] gap-6 border-t border-ink-800 pt-4">
                ...
                <div className="text-sm text-paper-300">
                  React · Next.js · Angular · Flutter · TypeScript · JavaScript
              ...
              <div className="grid grid-cols-[150px_1fr] gap-6 border-t border-ink-800 pt-4">
                ...
                <div className="text-sm text-paper-300">
                  Git · GitHub · Postman · Figma · VS Code · Laragon
                </div>
              </div>
              <div className="grid grid-cols-[150px_1fr] gap-6 border-t border-ink-800 pt-4">
                <div className="text-sm font-semibold">Focus areas</div>
                <div className="text-sm text-paper-300">
                  Booking and payment workflows · Offline-first mobile · CMS and
                  dashboard development · API design and integration
                </div>
              </div>
            </div>
          </div>
